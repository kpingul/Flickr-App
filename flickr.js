  ...
  var config = {
    ...
    function postResults(result){
      ...
      for(var index = 0, max = photos.length; index < max; index+=1 ) {
        ...
        html = '<li><a href= "https://farm' + photos[index].farmID + '.staticflickr.com/' + photos[index].serverID + '/' + photos[index].id + '_' + photos[index].secretID + '_c.jpg" title="' + photos[index].title + '"  class="img-responsive" data-gallery > <img src= "https://farm' + photos[index].farmID + '.staticflickr.com/' + photos[index].serverID + '/' + photos[index].id + '_' + photos[index].secretID + '_b.jpg" class="img-rounded styleimg"></a></li>';
